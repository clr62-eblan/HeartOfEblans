...
<div style="background: rgba(30, 30, 40, 0.7); border-radius: 15px; padding: 25px; margin: 30px auto; max-width: 900px; box-shadow: 0 5px 15px rgba(0,0,0,0.2);">
  ...
  <h3>Версия 1.2 - Что нового?</h3>  
<h3>✨ Основные изменения:</h3>  
<ol>  
  <li><strong>Совместимость</strong>  
    <ul>  
      <li>🚀 Теперь мод <strong>не требует никаких DLC</strong> для запуска!</li>  
    </ul>  
  </li>  
  <li><strong>Изменения на карте</strong>  
    <ul>  
      <li>🌍 Границы большинства стран <strong>переработаны</strong>.</li>  
      <li>🏳️ Добавлены <strong>новые страны</strong>.</li>  
    </ul>  
  </li>  
  <li><strong>Новые фокусы</strong>  
    <ul>  
      <li>🎯 <strong>Пятёрка</strong> и <strong>Братишкин</strong> получили <strong>уникальные ветки фокусов</strong>.</li>  
      <li>🔄 Полностью <strong>переработаны</strong> фокусы для <strong>Мазелова, Стинта и Тохи</strong>.</li>  
    </ul>  
  </li>  
</ol>
